...
public class ExportToExcelManager implements IRunnableWithProgress {
	...
	public void save(IProgressMonitor monitor) throws IOException,
		...
		XSSFWorkbook workbook = this.loadTemplateWorkbook(this.template,
				this.diagram);

		// ・ｽt・ｽ@・ｽC・ｽ・ｽ・ｽ・ｽJ・ｽ・ｽ・ｽﾄゑｿｽ・ｽ・ｽ・ｽﾛの擾ｿｽ・ｽ・ｽ・ｽ・ｽ・ｽﾝエ・ｽ・ｽ・ｽ[・ｽ≠・ｽ・ｽo・ｽ・ｽ・ｽ・ｽ・ｽﾟに茨ｿｽU・ｽ・ｽ・ｽ・ｽ・ｽﾅ擾ｿｽ・ｽ・ｽ・ｽ・ｽ・ｽﾝ擾ｿｽ・ｽ・ｽ・ｽ・ｽs・ｽ・ｽ
	...
	private boolean backup(File file, boolean isBackupEnable)
		...
		try {
			...
			String backupFilePath = path.substring(0, path.indexOf(".xlsx"))
					+ "_back.xlsx";
